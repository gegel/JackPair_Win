...
unsigned char ike_ber(unsigned char* m, short lr, signed char* logout); //output test log of modem statistic in IKE mode
void work_ber(unsigned char* m, short lr, signed char* logout); //optionally output test log of modem statistic in WORK mode
